  var VERTEXDRAW = (function() {
    ...
    function Synth(audiolet, frequency, outY) {
      ...
      if (Synth.prototype.synthSetup == undefined) {
        Synth.prototype.synthSetup = function() {
          ...
          this.envelope = new PercussiveEnvelope(this.audiolet, 1, 0.2, 0.8, function() { this.audiolet.scheduler.addRelative(0, this.remove.bind(this));}.bind(this));
