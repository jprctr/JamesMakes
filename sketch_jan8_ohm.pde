...
void draw() { 
	...
	textFont(font, 30); 
	text("And in the meantime", 20, 340);
	text("We do have a pretty good view", 20, 380);
	text("Who else has this kind of Forest?", 20, 420);
	text("As far as the eye can see", 20, 460);
	fill(255, 200);
