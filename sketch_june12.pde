/*
@pjs preload="data/PT_RNA_0000.gif, 
data/PT_RNA_0001.gif,
data/PT_RNA_0002.gif,
data/PT_RNA_0003.gif,
data/PT_RNA_0004.gif,
data/PT_RNA_0005.gif,
data/PT_RNA_0006.gif,
data/PT_RNA_0007.gif,
data/PT_RNA_0008.gif,
data/PT_RNA_0009.gif,
data/PT_RNA_0010.gif,
data/PT_RNA_0011.gif,
data/PT_RNA_0012.gif,
data/PT_RNA_0013.gif,
data/PT_RNA_0014.gif,
data/PT_RNA_0015.gif";
*/
...
void setup() {
  size(720, 720);
  frameRate(15);
  animation1 = new Animation("PT_RNA_", 15);
  animation2 = new Animation("PT_RNA_", 15);
  xpos = width/2;
  ypos = height/2;
